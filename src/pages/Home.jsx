  ...
  return (
    <>
      ...
      <div className="flex  w-full justify-center bg-gradient px-14 py-[110px] md:p-5">
        <div className=" rounded-[20px] border-[7px] border-solid border-white-A700 bg-white-A700 md:w-full md:p-5">
          ...
          <div className="bg-gradient1 px-[5px]">
            <div className="flex flex-col gap-x-5 px-2.5">
              <div className="mt-4 flex flex-col gap-x-5">
                <div className="flex flex-1 flex-col items-start gap-1">
                  <div className="flex w-[76%] justify-center rounded-[15px] bg-gradient3 px-2.5 md:w-full">
                ...
                <div className="flex items-center gap-[5px] self-stretch">
                  <div className="flex flex-1 gap-2.5 flex-wrap">
                    ...
                    <Button
                      ...
                      size="sm"
                      shape="round"
                      className="w-fit flex-1 border border-solid border-blue-A200 font-medium"
                    >
                      Baggit{" "}
                    </Button>
                    <div className="flex px-1 justify-end rounded-[5px] border border-solid border-blue-A200 bg-gray-50_02 py-[3px] flex-wrap">
                      <Text as="p" className="self-end !font-medium !text-blue-A200 w-fit">
                        Multi Compartment
                      </Text>
                    </div>
                  </div>
              ...
              <div className="mb-[21px] flex flex-col gap-2.5">
                  ...
                  <div className="flex w-[76%] flex-col gap-2.5 rounded-[20px] bg-gradient4 p-2.5 md:w-full">
                    <div className="flex items-center justify-center gap-[11px] rounded-[10px] bg-white-A700 p-[7px]">
                      <Img
                        ...
                        alt="image"
                        className="w-[34%] rounded-[5px] object-cover"
                      />
                ...
                <div className="flex flex-col gap-[9px]">
                  ...
                  <div className="flex  flex-col items-start gap-2.5">
                    <div className="flex flex-wrap w-[85%] gap-2.5 md:w-full">
                    <Button
                        shape="round"
                        rightIcon={
                          <Img
                            ...
                            alt="check-square-2"
                            className="h-[11px] w-fit"
                          />
                        }
                        className="min-w-[150px] gap-[5px]"
                      >
                        Long Strap
                      </Button>
                      <Button
          ...
          <div className="flex flex-col items-center justify-center gap-[9px] border-2 border-solid border-white-A700 bg-gradient2">
            ...
            <div className="flex flex-row flex-wrap justify-start gap-[5px] items-center md:px-5">
              <div className=" !text-gray-400">
                Powered by Krunk.ai
              </div>
              
              <Img src="images/img_logo.png" alt="logo_one" className="h-[18px] w-[18px]  object-cover" />
            </div>
          </div>
        </div>
      </div>
